...
#    Updated: 2023/04/12 15:13:23 by ttavares         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCSOLONG =	./get_next_line/get_next_line.c ./get_next_line/get_next_line_utils.c \
			...
			./srcs/flood_fill.c ./srcs/check_map_extra.c ./srcs/moves_extra.c ./srcs/moves_validation.c ./srcs/flood_fill_extra.c
...
SRCSOLONG_BONUS =	./get_next_line/get_next_line.c ./get_next_line/get_next_line_utils.c \
					...
					./srcs/bonus/animate_bonus.c ./srcs/bonus/flood_fill_extra_bonus.c
